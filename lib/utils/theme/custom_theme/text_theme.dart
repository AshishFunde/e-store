...
class ETextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleMedium: TextStyle().copyWith(fontSize: 16,fontWeight: FontWeight.normal,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium: TextStyle().copyWith(fontSize: 16,fontWeight: FontWeight.normal,color: Colors.white),
